...
- 'Yield-Ping-Pong' pattern is easily transformed into 'Yield-House-Wife' pattern, whose name is not intended to be sexists but is a reflection upon the 1960s, 70s, and 80s, aclaimed method of solving the Conundrum of Intersteller Communication, in which radio operators are light-years apart.
